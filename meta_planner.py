...
class MetaPlanner():
    ...
    def plan(self, meta_calls, observations):
        return self.a_star(meta_calls, observations)[0]
    
    def actions_from_path(self, path, meta_calls, observations):
    ...
    def a_star(self, meta_calls, observations):
        ...
        return self.actions_from_path(path, meta_calls, observations)