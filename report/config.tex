...
\usepackage{array} % needed for the m{} column type
\usepackage{cellspace} % needed for the cell space
\setlength{\cellspacetoplimit}{4pt} % set space above contents
\setlength{\cellspacebottomlimit}{4pt} % set space below contents
