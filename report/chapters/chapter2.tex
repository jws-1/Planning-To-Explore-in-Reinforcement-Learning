...
The goal of the agent is to learn how to map states to actions in order to maximise the expected cumulative long-term reward, this mapping is known as the \textbf{policy} \cite{Sutton1998}.
...
\subsection{Simple Model-Based Exploration}
