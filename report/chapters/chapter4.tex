...
This approach means that exploration is driven by the intrinsic motivation of the agent, as it believes one policy might be better than another. This is also an optimistic approach, based on the principle of \textit{optimism in the face of uncertainty} \cite{lai-allocation}; until we have actually verified the correctness of the model through experience in the real environment, we are in a state of uncertainty due to the inevitable inaccuracies.
